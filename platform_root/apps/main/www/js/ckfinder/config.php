...
require_once '/home/nova/public_html/_core/adminInit.php';
...
function CheckAuthentication()
{
	...
	return user::hasAccess('CONTENT');
}

// LicenseKey : Paste your license key here. If left blank, CKFinder will be
// fully functional, in demo mode.
$config['LicenseName'] = 'www.ddmnovastar.com';
$config['LicenseKey'] = 'NJH5-W3QJ-MJKU-MPCY-9V6N-ZTY8-G1KY';
...
*/
$baseUrl = 'http://dev.ddmnovastar.com/userfiles/';
...
ATTENTION: The trailing slash is required.
*/
$baseDir = '/home/nova/public_html/userfiles/';
